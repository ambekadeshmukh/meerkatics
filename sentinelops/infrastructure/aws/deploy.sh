#!/bin/bash
# sentinelops/infrastructure/aws/deploy.sh
...
prompt_for_parameters() {
    ...
    read -p "IP range that can access SentinelOps services [$ACCESS_LOCATION]: " input
...
show_outputs() {
    echo -e "${BLUE}Deployment complete! Here are your SentinelOps endpoints:${NC}"
