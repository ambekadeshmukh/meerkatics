#!/usr/bin/env python
# Example of using SentinelOps SDK with OpenAI

import os
import time
from sentinelops.sdk import OpenAIMonitor
...
def run_example():
    """Run a simple example using the SentinelOps SDK with OpenAI."""
    print("Running SentinelOps SDK example with OpenAI...")
    ...
    try:
        ...
        # Print metrics collected by SentinelOps
        print("\nMetrics collected by SentinelOps:")
