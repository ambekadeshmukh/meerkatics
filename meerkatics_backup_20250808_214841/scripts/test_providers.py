#!/usr/bin/env python3
# meerkatics/scripts/test_providers.py
...
def test_openai():
    ...
    try:
        ...
        monitor = OpenAIMonitor(
            api_key=api_key,
            model="gpt-3.5-turbo",
            application_name="meerkatics-test"
        )
...
def main():
   parser = argparse.ArgumentParser(description="Test Meerkatics provider integrations")
   ...
   print("=== Meerkatics Provider Integration Test ===")
