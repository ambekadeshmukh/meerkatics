#!/bin/bash
# meerkatics/infrastructure/scripts/quick-deploy.sh
...
print_banner() {
    ...
    echo "  __  __               _         _   _          "
   echo " |  \/  |             | |       | | (_)         "
   echo " | \  / | ___  ___ _ _| | ____ _| |_ _  ___ ___ "
   echo " | |\/| |/ _ \/ _ \ '__| |/ / _` | __| |/ __/ __|"
   echo " | |  | |  __/  __/ |  |   < (_| | |_| | (__\__ \\"
   echo " |_|  |_|\___|\___|_|  |_|\_\__,_|\__|_|\___|___/"
   echo -e "${NC}"
...
POSTGRES_PASSWORD=meerkaticsdev
...
start_services() {
   echo -e "${BLUE}Starting Meerkatics services...${NC}"
   ...
   echo -e "${GREEN}Meerkatics services started successfully!${NC}"
}
