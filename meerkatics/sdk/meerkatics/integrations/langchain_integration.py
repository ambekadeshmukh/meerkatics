# meerkatics/sdk/meerkatics/integrations/langchain_integration.py
import time
import uuid
import logging
...
class MonitoredLLM(LLM):
    """
    A LangChain LLM that is monitored by Meerkatics.
    ...
    def __init__(
        ...
        Args:
            ...
            monitor: The Meerkatics monitor instance
        """
        super().__init__()
        self.llm = llm
        self.monitor = monitor
        ...
        handler = MeerkaticsCallbackHandler(monitor)
    ...
    def _llm_type(self) -> str:
        ...
        return f"Meerkatics-{self.llm._llm_type}"
...
class MonitoredChatModel(BaseChatModel):
    """
    A LangChain Chat Model that is monitored by Meerkatics.
    ...
    def _llm_type(self) -> str:
        """Return the type of LLM."""
        return f"Meerkatics-{self.chat_model._llm_type}"
