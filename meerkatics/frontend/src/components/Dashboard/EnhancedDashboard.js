...
const Dashboard = () => {
  ...
  const handleExportDashboard = () => {
    ...
    a.href = url;
    a.download = `meerkatics-dashboard-${dashboardType}-${new Date().toISOString()}.json`;
    a.click();
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <p className="text-gray-700 mb-4">
                    Meerkatics has analyzed {formatNumber(hallucinationData?.total_analyzed || 0)} responses across 
